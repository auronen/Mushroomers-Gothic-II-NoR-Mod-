...
const string Bookstand_Report_Page0_1 = "                ПРОТОКОЛ";
const string Bookstand_Report_Page0_2 = "      о хищении в Верхнем квартале";
const string Bookstand_Report_Page0_3 = "        портового города Хориниса";
const string Bookstand_Report_Page0_4 = "Сего числа сего года от гражданина Г. в уполномоченные органы поступило заявление о незаконном присвоении (хищении) имущества, коим является небольшой предмет из драгоценного металла серого цвета с украшением из драгоценного камня красного цвета (серебряное кольцо с рубином).";
const string Bookstand_Report_Page0_5 = "Уполномоченные органы в лице городского патруля незамедлительно среагировали на факт обращения и прибыли на место происшествия. Выполнив опрос свидетелей и осмотр вещественных доказатальств, ответственные лица в лице стажников П. и Х. приступили к погоне.";
const string Bookstand_Report_Page0_6 = "      Управление: СТРЕЛКИ, Home, End";
...
const string Bookstand_Report_Page1_1 = "Предполагаемый преступник двигался в направлении Рыночной площади. Дабы пресечь сокрытие с места преступления путем Восточных ворот в силу был введен план перехвата. Намерение подозреваемого удалось предотвратить, но он отказался от законного требования сдаться и полез на дерево, что к городской стене примыкает.";
const string Bookstand_Report_Page1_2 = "Для предотвращения бегства подозреваемого путем городской стены находившийся поблизости стражник Р. направил на него табельное оружие дальнего действия (арбалет) и произвел предупредительный выстрел в воздух, а стражники П. и Х. отрезали ему пути отступления под деревом.";
...
const string Bookstand_Report_Page2_1 = "Подозреваемый ответил нецензурными словами в адрес уполномоченных органов и государственной власти. Затем он произвел падение с дерева на мостовую, в результате чего получил травмы, несовместимые с жизнью.";
const string Bookstand_Report_Page2_2 = "В результате тщательного осмотра похищенное имущество при подозреваемом не обнаружено.";
const string Bookstand_Report_Page2_3 = "Дежурные стражники";
const string Bookstand_Report_Page2_4 = "Пабло";
const string Bookstand_Report_Page2_5 = "Хогван";
...
//================================================================
//на верфи +
const string Shipbuilding_S1_1 = "Судостроение";
const string Shipbuilding_S1_2 = "Прежде чем браться за строительство морского судна, надлежит подробно рассчитать его размерения и соотношение частей, а также подобрать и подготовить древесину.";
const string Shipbuilding_S1_3 = "Основанием всякому судну служит киль, к которому крепятся штевни и шпангоуты. Хорошо, если киль изготовлен из целого ствола драконьего дерева, имеющего отходящий под нужным углом корень.";
const string Shipbuilding_S1_4 = "Для шпангоутов же, бимсов и обшивки лучше брать брусья и доски из тщательно высушенной древесины горной сосны, срубленной во время зимних холодов. Из нее же надлежит делать и мачты, хотя для них подойдет и орочий бук.";
...
const string CourtCase_S1_1 = "Торговец Диего, 36 лет от роду, наполовину варрантец, житель Верхнего квартала Хориниса, обвиняется в контрабанде магической руды, предназначавшейся для королевских оружейных мастерских. Также, согласно показаниям его компаньона Гербрандта, торговца, жителя Нижнего квартала, он неоднократно продавал оружие пиратам, преследуемым законом и проклятым Инносом.";
const string CourtCase_S1_2 = "Вина подсудимого полностью доказана показаниями свидетелей и содержимым тайника, указанного Гербрандтом. Диего приговаривается к смертной казни, которая, милостью нашего повелителя короля Робара II заменяется на пожизненную каторгу в рудниках Минненталя...";
