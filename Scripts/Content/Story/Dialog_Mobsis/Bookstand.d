...
const string Bookstand_01_S1_1 = "Испытание Огнем";
const string Bookstand_01_S1_2 = "Хотя послушник может чувствовать себя готовым пройти Испытание Магией, из этого не следует, что он обязательно будет выбран. Если, однако, он принял это решение после зрелого размышления и если он настаивает на своем решении, он наделен правом требовать прохождения этого Испытания, и ни один маг не может отказать ему в этом. Но послушник обязан не только пройти Испытание Магией, но также найти просвещение через огонь. ";
const string Bookstand_01_S1_3 = "Это Испытание должно позволять дать оценку мудрости силе и ловкости послушника. Следовательно, он должен пройти три испытания, каждое из которых дается ему одним из магов Высшего Совета, прежде чем ему будет позволено принять Клятву Огня и присоединиться к Соглашению Огня.";
const string Bookstand_01_S1_4 = "Такова воля Инноса и так тому и быть.";
const string Bookstand_01_S1_5 = "Высший совет";
...
const string FINALDRAGONEQUIPMENT_S1_1 = "... Я надеюсь, что этот купол защитит руду от коварства Белиара. Король настолько наивен, что верит, что мы строим этот купол для предотвращения побегов. Что ж, пока эта уловка позволяет нам следовать нашей высшей цели, пусть так и будет. Мне остается только надеяться, что у нас остается достаточно времени, чтобы подготовиться к битве. Как только купол вокруг Долины рудников будет воздвигнут, я соберу все силы, имеющиеся в моем распоряжении, чтобы принять участие в грядущей битве.";
const string FINALDRAGONEQUIPMENT_S1_2 = "... Я следовал инструкциям и просто окропил святой водой Инноса чистый рунный камень, лежащий на рунном столе. Рунный камень был уничтожен. Я подозреваю, что это заклинание подвластно только Избранному.";
const string FINALDRAGONEQUIPMENT_S1_3 = "Я оставил священную ауру Инноса под защитой монастыря. Настоятель монастыря позаботится о ней до тех пор, пока не объявится Избранный.";
const string FINALDRAGONEQUIPMENT_S1_4 = "Слезы Инноса, вероятно,  будут играть важную роль в грядущей битве. Но слишком опасно оставлять их у всех на виду. Я лучше спрячу их здесь, в библиотеке.";
const string FINALDRAGONEQUIPMENT_S1_5 = "Чтобы достичь секретного места,  необходимо создать руну телепортации. Для этого необходим чистый рунный камень и небольшая бутылочка святой воды. При помощи этой руны можно телепортироваться в комнату.";
const string FINALDRAGONEQUIPMENT_S1_6 = "Теперь я вполне уверен, что слезы Инноса - именно то, что паладины древности использовали в давно забытом ритуале 'Освящение Меча'. Это означает, что при помощи этой бутылочки, что я нашел, я смогу придать дополнительную силу освящаемому оружию. ";
const string FINALDRAGONEQUIPMENT_S1_7 = "Оружие повелителя драконов.";
const string FINALDRAGONEQUIPMENT_S1_8 = "Чтобы сделать доспехи из чешуи дракона максимально прочными, чешуйки можно покрыть рудой, добытой в долине на острове Каринис.";
const string FINALDRAGONEQUIPMENT_S1_9 = "Чтобы изготовить меч, достойный  повелителя драконов, этот меч должен быть закален в драконьей крови. 5 пиал крови могут придать стали непревзойденную остроту и прочность.";
const string FINALDRAGONEQUIPMENT_S1_10 = "Примечание: 'Каринис' вероятно соответствует нынешнему названию 'Хоринис'.";
